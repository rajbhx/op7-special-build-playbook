...
> Auto-generated from `docs/field-notes/log.yml` in `rajbhx/iceraven-op7`
> by `.github/workflows/playbook-sync.yml`. Do not edit by hand.
> Add/update entries in the source log; the next sync regenerates this file.
